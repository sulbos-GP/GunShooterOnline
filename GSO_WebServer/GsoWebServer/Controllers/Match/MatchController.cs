...
namespace StatisticServer.Controllers.Match
{
    ...
    public class MatchController : ControllerBase
    {
        ...
        public MatchController(IGameService gameservice, IRatingSystemService ratingSystem)
        {
        ...
        [HttpPost]
        [Route("Outcome")]
        public async Task<MatchOutComeRes> Outcome([FromHeader] HeaderDTO header, [FromBody] MatchOutComeReq request)
        {
