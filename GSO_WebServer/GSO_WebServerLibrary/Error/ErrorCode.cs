namespace GSO_WebServerLibrary.Error
{
    public class ErrorInfo
    {
        public WebErrorCode mErrorCode { get; set; } = WebErrorCode.None;
        public string mErrorDescription { get; set; } = string.Empty;
    }

    public enum WebErrorCode : ushort
    {
        None = 0,
